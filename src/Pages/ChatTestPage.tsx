...
const Test = (props: any) => {
  ...
  return (
    <Container sx={{ boxShadow: 3, borderRadius: 5, mt: 10, p: 3 }}>
        ...
        <Grid item xs={3}>
          ...
          >
            <FormControl variant="outlined" fullWidth required color="success">
              <InputLabel sx={{ fontSize: 13 }}>아이디</InputLabel>
              <OutlinedInput
                type="text"
                sx={{ fontSize: 14 }}
                value={email}
            ...
            <FormControl
              ...
              color="success"
            >
              <InputLabel sx={{ fontSize: 13 }}>방 번호</InputLabel>
              <OutlinedInput
                type="text"
                sx={{ fontSize: 14 }}
                value={roomId}
            ...
            <FormControl
              ...
              color="success"
            >
              <InputLabel sx={{ fontSize: 13 }}>채팅 내용</InputLabel>
              <OutlinedInput
                type="text"
                sx={{ fontSize: 14 }}
                value={context}
